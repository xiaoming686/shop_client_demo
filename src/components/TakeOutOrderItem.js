...
export default function TakeOutOrderItem(props) {
  return (
    <View style={{ marginHorizontal: 19, marginTop: 23, padding: 20, backgroundColor: '#FFFFFF', borderRadius: 20 }}>
      ...
      {/* 8 */}
      <TouchableOpacity onPress={() => { props.props.navigation.navigate('TakeoutOrderDetail') }} style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', marginTop: 50 }}>
