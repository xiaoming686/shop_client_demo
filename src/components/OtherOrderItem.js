    ...
    <View style={{ margin: 17.5, marginBottom: 0, padding: 15.5, backgroundColor: '#FFFFFF', borderRadius: 20, width: 328.5 }}>
      ...
      <TouchableOpacity activeOpacity={1} onPress={() => { props.props.props.navigation.navigate('OtherOrderDetail') }} >
        <View style={{ flexDirection: 'row', height: 30, alignItems: 'center' }}>
          <Text style={{ fontSize: 19, color: '#3F3C3C', fontWeight: 'bold', lineHeight: 30 }}>取餐号{props.num}</Text>
          <View style={{ flexDirection: 'row', width: '70%', justifyContent: 'space-between', marginLeft: 14 }}>
            ...
            <Text style={{ color: props.byself === '自提' ? '#00CB88' : '#5FA6EE', fontSize: 17, lineHeight: 30 }}>自提</Text>
          </View>
        </View>
        {
          props.byself ?
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, borderTopWidth: 1, borderColor: '#ececec', paddingTop: 10 }}>
              <Text style={{ backgroundColor: '#ff8c00', marginRight: 10, fontSize: 12, padding: 3, color: '#ffffff' }}>预定</Text>
              <Text style={{ fontWeight: '700', color: '#3F3C3C' }}>预订单/今日13:30自提</Text>
            </View>
            :
            <></>
        }
        <View style={{ marginTop: 10, paddingVertical: 10, borderBottomWidth: 1, borderTopWidth: 1, borderStyle: 'dotted', borderColor: '#ececec' }}>
