    ...
    if (!this.state.account) {
      ...
      if (true) {
        ...
        setTimeout(function(){
          ...
          that.props.navigation.navigate('NavTab')
        }, 1000)
    ...
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <View style={{ borderRadius: 10, height: 46, width: 277.5, backgroundColor: '#FFFFFF', flexDirection: 'row', marginTop: 39, alignItems: 'center', }}>
          ...
          <TextInput onSubmitEditing={this.checkAccount} clearButtonMode="always" style={{ marginLeft: 35, fontSize: 18.41, }} placeholder="请输入邮箱"></TextInput>
        </View>
        {/* 3-用户名输入 */}
        <View style={{ borderRadius: 10, height: 46, width: 277.5, backgroundColor: '#FFFFFF', flexDirection: 'row', marginTop: 20, alignItems: 'center' }}>
          ...
          <TextInput onSubmitEditing={this.checkUserame} clearButtonMode="always" style={{ marginLeft: 35, fontSize: 18.41, }} placeholder="请输入用户名"></TextInput>
        </View>
        {/* 4-密码输入 */}
        <View style={{ borderRadius: 10, height: 46, width: 277.5, backgroundColor: '#FFFFFF', flexDirection: 'row', marginTop: 20, alignItems: 'center' }}>
          <Image style={{ marginLeft: 20, width: 20, height: 20, resizeMode: 'contain' }} source={require('../../assets/images/png/password.png')} />
          <TextInput onSubmitEditing={this.checkPassword} clearButtonMode="always" secureTextEntry={true} style={{ marginLeft: 35, fontSize: 18.41, }} placeholder="请输入密码"></TextInput>
        </View>
        {/* 5-记住我 */}
